...
const applications: ApplicationItem[] = [
  { appName: 'ABS-BFF', appDesc: 'ABS 系统的 BFF 服务' },
  { appName: '用户中心', appDesc: '统一身份与用户信息管理' },
  { appName: '核心服务', appDesc: '核心业务参数配置' },
  { appName: 'CICI服务', appDesc: '持续集成与发布服务' },
  { appName: '公共配置', appDesc: '跨应用共享参数' },
  { appName: '自动化任务', appDesc: '批量作业与任务调度' },
  {
